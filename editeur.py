...
class Ui_notepad(object):
    def setupUi(self, notepad):
        ...
        self.boutton_enregistrer.setGeometry(QtCore.QRect(280, 10, 96, 27))
        ...
        self.boutton_fermer.setGeometry(QtCore.QRect(390, 10, 85, 27))
        self.boutton_fermer.setObjectName(_fromUtf8("boutton_fermer"))
        self.editor_window = QtGui.QTextEdit(self.centralwidget)
        self.editor_window.setGeometry(QtCore.QRect(220, 230, 341, 281))
        ...
        self.boutton_enregistrer_sous.setGeometry(QtCore.QRect(148, 10, 121, 27))
